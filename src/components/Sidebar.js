    ...
    return <nav id="sidebar" className="sidebar js-sidebar">
        <div className="sidebar-content js-simplebar">
            ...
            <img src={vlncy} height="30px"></img>
                <span className="align-middle">vlncy</span>
            </a>
            ...
            <ul className="sidebar-nav">
                ...
                <li className="sidebar-item">
                    <a className="sidebar-link" href="home.html">
                        <i className="align-middle" data-feather="book"></i> <span className="align-middle">Home</span>
                    </a>
                </li>

                <li className="sidebar-item">
                    <a className="sidebar-link" href="home.html">
                        <i className="align-middle" data-feather="users"></i> <span className="align-middle">User</span>
                    </a>
                </li>
